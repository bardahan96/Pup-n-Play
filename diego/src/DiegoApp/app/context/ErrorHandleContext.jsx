...
export const ErrorHandleContext = createContext(null);

export function ErrorHandleProvider({ children }) {
  ...
  return <ErrorHandleContext.Provider value={value}>{children}</ErrorHandleContext.Provider>;
}
